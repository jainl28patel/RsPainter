...
int main()
{
    ...
    // Diffuse Map Texture Coordinates
    ...
    // Loading Texture
    Texture tex("../resources/container2.png", GL_RGBA);
    Texture tex2("../resources/container2_specular.png", GL_RGBA);
    lightingShader.use();
...
//        lightingShader.setVec3("light.direction", -0.0f, -0.0f, -0.1f);
        lightingShader.setVec3("light.position", camera.Position);
        lightingShader.setVec3("light.direction", camera.Front);
        lightingShader.setFloat("light.cuttoff", glm::cos(glm::radians(12.5f)));
